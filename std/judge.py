        ...
        for test in self.tests:
            ...
            if "execution" not in inf:
                ...
                if checker == "std":
                    ...
                    if (
                        external_program == "./checker.exe"
                        and not util.file_exists(self.dir + "/problem/" + external_program)
                        and util.file_exists(self.dir + "/problem/" + "checker.cc")
                    ):
                        logging.info("**** compiling external checker ****")
                        os.system(
                            "g++ %s -o %s" % (self.dir + "/problem/checker.cc", self.dir + "/problem/checker.exe")
                        )
